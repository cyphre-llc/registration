	...
	<?php else: ?>
		<form action="<?php print_unescaped(OC_Helper::linkToRoute('registration.send.email')) ?>" method="post" id="regist">
			...
			<p class="infield groupmiddle">
				...
				<input type="email" name="email" id="email" placeholder="" value="<?php echo $_['email']; ?>" required autofocus />
				<img style="top:2.7em;" class="svg" src="<?php print_unescaped(image_path('', 'actions/mail.svg')); ?>" alt=""/>
			</p>

			<p class="infield groupmiddle">
				<label for="email-clone"><?php print_unescaped($l->t( 'Email retype' )); ?></label><br/>
				<input type="email" name="email-clone" id="email-clone" placeholder=""/>
				<img style="top:2.7em;" class="svg" src="<?php print_unescaped(image_path('', 'actions/mail.svg')); ?>" alt=""/>
			</p>
			<br/>
