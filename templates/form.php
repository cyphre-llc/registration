...
?>
		...
		<p class="infield">
			<label for="address1" class="" style="color: #ccc"><?php print_unescaped($l->t( 'Suite/Apt#' )); ?></label><br>
			<input type="text" name="address1" id="address1" autocomplete="street-address1" maxlength="50" value="<?php echo $_['entered_data']['address1']; ?>" />
        </p>
